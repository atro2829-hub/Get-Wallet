...
public class GetWalletFirebaseMessagingService extends FirebaseMessagingService {

    private static final String TAG = "GetWalletFCM";
    ...
    public void onNewToken(@NonNull String token) {
        ...
        // The client-side JS will handle saving this token to Supabase
        // We broadcast it so the web layer can pick it up
        Intent intent = new Intent("com.getwallet.app.FCM_TOKEN");
