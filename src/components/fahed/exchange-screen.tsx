...
══════════════════════════════
Get Wallet - محفظتك الرقمية
`.trim();

    if (navigator.share) {
      try { await navigator.share({ title: 'سند التحويل - Get Wallet', text }); } catch {}
    } else {
                ...
                <div ref={receiptRef}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 p-4" style={{ borderBottom: `1px dashed ${voucherDividerColor}` }}>
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-bold" style={{ color: isDark ? '#FFF' : '#1a1a1a' }}>Get Wallet</p>
