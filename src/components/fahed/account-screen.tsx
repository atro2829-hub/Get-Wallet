...
export default function AccountScreen() {
  ...
  const handleShareProfile = () => {
    const text = `📱 حسابي في Get Wallet\n🆔 رقم الحساب: ${user?.userId || ''}\n👤 الاسم: ${user?.name || ''}`;
    if (navigator.share) {
              ...
              >
                ...
                <div className="px-5 pt-4 pb-2 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span className="text-white text-xs font-bold block">Get Wallet</span>
                      <span className="text-white/60 text-[9px]">Get Wallet</span>
                    </div>
                  </div>
        ...
        >
          <div className="p-4">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => {
                  const text = `🎁 استخدم كود الدعوة ${user?.userId || ''} في تطبيق Get Wallet واحصل على مكافأة!`;
