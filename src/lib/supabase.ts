/**
 * Supabase Client for Get Wallet - PRIMARY DATA SOURCE
 *
...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://lscehdlnbqcciejetruv.supabase.co';
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxzY2VoZGxuYnFjY2llamV0cnV2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI1ODAwMDQsImV4cCI6MjA5ODE1NjAwNH0.ANc2iDEjB68DmkwQC05GQoy-sXH7fdkk_gkUVdJ13Jo';
...
const supabaseServiceRoleKey = process.env.SUPABASE_SERVICE_ROLE_KEY
  ...
  || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxzY2VoZGxuYnFjY2llamV0cnV2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MjU4MDAwNCwiZXhwIjoyMDk4MTU2MDA0fQ.KmNoQkJQWZD_DyGANMegfFbC-JJzlbnhXRGAJRX1Z8w';
...
/**
 * Storage bucket names used in Get Wallet
 */
