// Service Worker for Get Wallet Admin
// Provides offline capability, caching, and background notification support

const CACHE_NAME = 'get-wallet-admin-v2';
const STATIC_CACHE = 'get-wallet-admin-static-v2';
const IMAGE_CACHE = 'get-wallet-admin-images-v2';
const API_CACHE = 'get-wallet-admin-api-v2';
...
<head>
  ...
  <title>Get Wallet Admin - Offline</title>
  <style>
...
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'Get Wallet Admin';
  ...
  const options = {
    ...
    tag: `get-wallet-admin-${type}-${Date.now()}`,
  };
