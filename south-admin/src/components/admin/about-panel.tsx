...
export default function AboutPanel() {
  ...
  const systemInfo = [
    { label: 'اسم التطبيق', value: 'Get Wallet', icon: Smartphone },
  ...
  return (
    <div className="space-y-6 max-w-[800px] mx-auto">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">معلومات عن Get Wallet</p>
      </div>
      ...
      <div className="ios-card p-6 text-center">
        ...
        <h2 className="text-xl font-bold text-foreground">Get Wallet</h2>
      ...
      <div className="text-center py-4">
        <p className="text-xs text-muted-foreground/60">
          © {new Date().getFullYear()} Get Wallet - All rights reserved
        </p>
