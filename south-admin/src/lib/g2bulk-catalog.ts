...
export async function fetchGameCatalogue(gameCode: string): Promise<G2BulkCatalogue[]> {
  ...
  try {
    ...
    const SUPABASE_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxzY2VoZGxuYnFjY2llamV0cnV2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI1ODAwMDQsImV4cCI6MjA5ODE1NjAwNH0.ANc2iDEjB68DmkwQC05GQoy-sXH7fdkk_gkUVdJ13Jo';
    const res = await fetch(
      `https://lscehdlnbqcciejetruv.functions.supabase.co/g2bulk-proxy/v1/games/${gameCode}/catalogue`,
      {
        headers: {
