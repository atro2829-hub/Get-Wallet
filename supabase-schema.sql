-- =====================================================
-- Get Wallet - Supabase Database Schema
-- Get Wallet - هيكل قاعدة البيانات الكامل
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.branding (
  ...
  app_name TEXT DEFAULT 'Get Wallet',
  app_name_en TEXT DEFAULT 'Get Wallet',
...
VALUES ('default', 'Get Wallet', 'Get Wallet', '#5C1A1B', '#8B2252', '#D4547A', '#3D0F10')
...
INSERT INTO public.app_config (key, value, description) VALUES
  ...
  ('projectConfig', '{"appName": "Get Wallet", "packageName": "com.qtbm.south", "latestVersion": "1.0.0", "minVersion": "1.0.0"}', 'إعدادات المشروع')
